    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="<?php echo base_url('admin/new_payroll'); ?>" method="post">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_btn" value="1">Generate</button>
                        <button type="submit" class="btn btn-default" name="submit_btn" value="2">Search</button>
                    </form>
                </div>
                <!-- /.card-body -->
            </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($payroll as $p) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('admin/del_new_payroll/' . $p['id_payroll']); ?>" class="btn btn-info btn-block btn-xs font-weight-bolder"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" id="telepon" name="no_telepon" required>
                            </div>
