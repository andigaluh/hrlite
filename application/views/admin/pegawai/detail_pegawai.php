                ...
                <div class="col-md-7">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart('admin/detail_pegawai/' . $pegawai['kode_pegawai']); ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="telepon" name="no_telepon" value="<?php echo $pegawai['no_telepon']; ?>" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>No Telepon</b> <a class="float-right"><?php echo $pegawai['no_telepon']; ?></a>
                                </li>
                                <li class="list-group-item">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo base_url('admin/add_data_lain/' . $pegawai['kode_pegawai']); ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="modal-body">
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>Tgl Lahir Suami / Istri</b> <a class="float-right"><?php echo $keluarga['tgl_lahir_pasangan']; ?></a>
                        </li>
                        <li class="list-group-item">
