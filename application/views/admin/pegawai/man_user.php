                ...
                <div class="box-body">
                    <form action="<?php echo base_url('admin/man_user'); ?>" method="post" id="form_id">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" id="nip" name="pegawai_kd" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="usernamejson" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Lengkap</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="nip">Kode Pegawai</label>
                                    <input type="text" class="form-control form-control-sm" id="nipjson" name="pegawai_kd" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
