                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">List Pegawai</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="timeline">
                                    <div class="table-responsive">
                                        <table id="id-table" class="table table-bordered table-striped" style="font-size:13px;">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>NIP</th>
